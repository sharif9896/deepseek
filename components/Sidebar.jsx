...
const Sidebar = ({ expand, setexpand }) => {
  ...
  return (
    <div className="h-screen max-md:h-screen bg-[#212327]">
      <div
        className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:bg-[#212327] ${
          expand ? "h-[100vh] p-4 w-64" : "md:w-20 w-0 max-md:overflow-hidden"
        }`}
      >
        <div className="">
          <div
          ...
          >
            ...
            <div
              ...
              className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-9 w-9 aspect-square roundedd-lg cursor-pointer"
            >
              ...
              >
                ...
                <div
                  className={`w-3 h-3 absolute bg-black z-10 rotate-45 ${
                    expand
          ...
          <button
            className={`mt-8 flex items-center justify-center cursor-pointer ${
              expand
                ? "bg-blue-700 hover:opacity-90 rounded-2xl gap-2 p-2.5 w-max"
          ...
          >
            <Image
              ...
              alt=""
            />
            <div className="absolute w-max z-30 -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">
              New chat
        ...
        <div className="">
          <div
            className={`mt-8 flex items-center z-30 cursor-pointer group relative ${
              expand
